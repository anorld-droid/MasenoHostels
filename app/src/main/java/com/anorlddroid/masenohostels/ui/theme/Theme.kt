...
private val DarkColorPalette = MasenoHostelsColors(
    brand = Lavender1,
...
fun MasenoHostelsTheme(
    ...
    ProvideMasenoHostelsColors(colors) {
        MaterialTheme(
...
@Composable
fun ProvideMasenoHostelsColors(
    colors: MasenoHostelsColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalMasenoHostelsColors provides colorPalette, content = content)
}

object MasenoHostelsTheme {
    val colors: MasenoHostelsColors
        @Composable
        get() = LocalMasenoHostelsColors.current
}

@Stable
class MasenoHostelsColors(
    ...
    fun update(other: MasenoHostelsColors) {
    ...
    fun copy(): MasenoHostelsColors = MasenoHostelsColors(
...
private val LocalMasenoHostelsColors = staticCompositionLocalOf<MasenoHostelsColors> {
